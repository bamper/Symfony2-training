...
class PageControllerTest extends WebTestCase
{
    public function testAbout()
    {
        ...
        $this->assertEquals(1, $crawler->filter('h1:contains("About Bartek blog")')->count());
    }
    ...
    public function testIndex()
    {
        ...
        var_dump($crawler->filter('h2:contains("' . $blogTitle .'")')->count());
    ...
    public function testContact()
    {
        ...
        $this->assertEquals(1, $crawler->filter('h1:contains("Contact me")')->count());
